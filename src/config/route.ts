...
import ComponentApplyList from '../components/ComponentApplyList.vue'
import ComponentEditMyTags from '../components/ComponentEditMyTags.vue'
...
const routes = [
    { path: '/',component: userLoginPage, redirect: '/login'},
    { path: '/login', component: userLoginPage },
    {
        ...
        children:[
            ...
            { path: 'friends/apply', component: ComponentApplyList, meta: {title: '新的朋友'} },
            ...
            { path: 'team/chat', component: ChatRoom, meta: {title: '队伍聊天'}},
            ...
            { path: 'user/my/tags', component: ComponentEditMyTags, meta: {title: '我的标签'} }
        ]
    }
