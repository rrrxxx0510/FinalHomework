...
<template>
  <ComponentAvaTeam :teamAva="teamInfo.teamAvatarUrl" :teamId="teamInfo.id"></ComponentAvaTeam>
...
import ComponentAvaTeam from '../components/ComponentAvaTeam.vue'
...
const teamInfo = JSON.parse(route.query.team) 
